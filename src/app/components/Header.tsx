...
export default function Header() {
    ...
    return (
        ...
        <div className="flex h-full w-full max-w-[1200px] items-center justify-between md:grid md:grid-cols-7 md:justify-items-center">
            {/* Logo */}
            <Link href="/ru" style={{ fontSize: 'clamp(1.5rem, 4vw, 3rem)' }} className={`${lexendExa.className} md:col-span-2 md:text-[48px]`}>
            ARTTEAM
            </Link>
            ...
            <Link href="/ru/#contact" className="text-[#183058] hover:text-[#B2C900] hover:scale-110 transition-all">Контакт</Link>
            <Link href="/ru/services" className="text-[#183058] hover:text-[#B2C900] hover:scale-110 transition-all">Услуги</Link>
            <Link href="/ru/#about-us" className="text-[#183058] hover:text-[#B2C900] hover:scale-110 transition-all">О компании</Link>
            <Link href="/ru/gallery" className="text-[#183058] hover:text-[#B2C900] hover:scale-110 transition-all">Галерея</Link>
        ...
        {isMobileMenuOpen && (
            ...
            <Link href="/ru/gallery" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-[#B2C900]">Галерея</Link>
